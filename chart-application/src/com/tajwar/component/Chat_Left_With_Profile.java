...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new com.tajwar.swing.ImageAvatar();
        txt = new com.tajwar.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/tajwar/icon/testing/dog.jpg")));
    ...
    private com.tajwar.swing.ImageAvatar IaImage;
