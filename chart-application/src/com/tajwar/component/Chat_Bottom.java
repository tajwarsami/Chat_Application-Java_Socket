...
import com.tajwar.service.Service;
import com.tajwar.swing.JIMSendTextPane;
...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        sb.setBackground(new Color(199, 243, 150));
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/tajwar/icon/send.png")));
        ...
        cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/tajwar/icon/more_disable.png")));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/tajwar/icon/more.png")));
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(9, 225, 147));
