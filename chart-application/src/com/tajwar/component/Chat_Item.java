...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/tajwar/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/tajwar/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.tajwar.swing.JIMSendTextPane();
    ...
    private com.tajwar.swing.JIMSendTextPane txt;
}
