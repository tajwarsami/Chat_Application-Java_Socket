...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/tajwar/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/tajwar/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/tajwar/icon/file.png")).getImage();
    }
