package com.tajwar.service;

import com.tajwar.app.MessageType;
import com.tajwar.connection.DatabaseConnection;
import com.tajwar.model.Model_File;
import com.tajwar.model.Model_File_Receiver;
import com.tajwar.model.Model_File_Sender;
import com.tajwar.model.Model_Package_Sender;
import com.tajwar.model.Model_Receive_Image;
import com.tajwar.model.Model_Send_Message;
import com.tajwar.swing.blurHash.BlurHash;
...
public class ServiceFIle {
    ...
    public Model_File addFileReceiver(String fileExtension) throws SQLException {
        Model_File data;
        String INSERT = "insert into files (FileExtension) values (?)";
    ...
    public void updateBlurHashDone(int fileID, String blurhash) throws SQLException {
        String UPDATE_BLUR_HASH_DONE = "update files set BlurHash=?, `Status`='1' where FileID=? limit 1";
    ...
    public void updateDone(int fileID) throws SQLException {
        String UPDATE_DONE = "update files set `Status`='1' where FileID=? limit 1";
    ...
    public Model_File getFile(int fileID) throws SQLException {
        String GET_FILE_EXTENSION = "select FileExtension from files where FileID=? limit 1";
...
// Path: server/src/com/tajwar/service/ServiceFIle.java
// Compare this snippet from chart-application/src/com/tajwar/component/Chat_Bottom.java:
//         add(scroll, "w 100%");
